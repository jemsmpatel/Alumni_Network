<nav class="bg-gray-800 text-white fixed top-0 w-full px-4 py-5 z-10">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <ul class="hidden md:flex space-x-9 items-center nav-underline text-xl mr-3">
            <li><a href="/" class="hover:text-yellow-400 transition"><span>Home</span></a></li>
            <li><a href="/about" class="hover:text-yellow-400 transition"><span>About</span></a></li>
            <li><a href="/event" class="hover:text-yellow-400 transition"><span>Events</span></a></li>
            <li><a href="/alumni" class="hover:text-yellow-400 transition"><span>Alumni</span></a></li>
            <li><a href="/contact" class="hover:text-yellow-400 transition"><span>Contact</span></a></li>
        </ul>
    ...
    <div id="mobileMenu" class="md:hidden mt-3 hidden space-y-2 px-2">
        <a href="/" class="block py-1 hover:text-yellow-400">Home</a>
        <a href="/about" class="block py-1 hover:text-yellow-400">About</a>
        <a href="/event" class="block py-1 hover:text-yellow-400">Events</a>
        <a href="/alumni" class="block py-1 hover:text-yellow-400">Alumni</a>
        <a href="/contact" class="block py-1 hover:text-yellow-400">Contact</a>
        @auth
